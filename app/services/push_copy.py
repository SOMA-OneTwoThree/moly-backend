...
_POOLS: dict[str, dict[str, list[tuple[str, str]]]] = {
    ...
    DIARY_TEASER: {
        "ko": _pool(_T_KO, [
            ...
            "어제 일기 아직 아무도 안 읽었어. 첫 독자는 너였으면 해.",
        ...
        "en": _pool(_T_EN, [
            "I wrote a diary yesterday. You haven't seen it yet.",
            "Guess what I wrote yesterday. Come see if you're curious.",
            "Yesterday's diary is still sitting there. Take a peek.",
            "Nobody has read yesterday's diary yet. I'd love it to be you.",
            "I put some heart into yesterday's entry. I hope you'll see it.",
            "I secretly wrote a diary last night. Aren't you curious?",
            "Guess who yesterday's diary is about. Come and check.",
            "I've been waiting to show you what I wrote yesterday.",
            "Yesterday's diary is waiting for a reader.",
            "I saved you a little bedtime read. My diary from yesterday.",
        ]),
        "ja": _pool(_T_JA, [
            "昨日の日記を書いておいたんだ。まだ見てないよね。",
            "昨日の日記に何を書いたと思う？気になったら見に来てね。",
            "昨日残した日記がそのままなんだ。こっそりのぞいてみて。",
            "昨日の日記はまだだれにも読まれてないよ。最初の読者はきみがいいな。",
    ...
    FIRST_TOUCH: {
        ...
        "en": _pool(_T_EN, [
            ...
            "Would you be my first friend? I'll be right here.",
    ...
    DEFAULT_LONG: {
        ...
        "en": _pool(_T_EN, [
            ...
            "No pressure at all. One hello is plenty.",
        ]),
        "ja": _pool(_T_JA, [
