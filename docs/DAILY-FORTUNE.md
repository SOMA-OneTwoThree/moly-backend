...
한국어는 총평 200묶음과 네 분야 각 200문단을 완성 문단 단위로 새로 작성한다. 첫 문장에 운세 해석을 제시하고 그 해석에 맞는 제안을 이어간다. 기존 원고의 문장 순환·조합이나 구간별 첫 문장만 바꾸는 방식은 사용하지 않는다. 약간의 자연스러운 표현 재사용은 허용하지만 같은 전체 문단은 중복하지 않는다.
...
```json
{
  ...
  "result": {
    ...
    "overall": {
      "score": 42,
      "headline": "오늘은 작은 걱정이 실제보다 커 보일 수 있어.",
      "do": "확인된 내용만 따로 정리해봐.",
      "pause": "아직 모르는 일을 나쁜 쪽으로 단정하지 마.",
      "flow": [
        "확실하지 않은 부분을 혼자 생각하다 보면 좋지 않은 경우부터 떠오를 수 있어. 지금 확인할 수 있는 사실부터 살펴봐.",
        "아직 모르는 내용은 확인될 때까지 판단하지 않아도 괜찮아. 다른 일에 잠깐 집중하면 생각이 덜 꼬일 수 있어.",
        "오늘은 예상과 사실을 구분하는 것만으로도 마음이 편해져."
      ]
    },
    "lucky_color": {
      "key": "green",
    ...
    "categories": {
      "love": {
        "score": 69,
        "text": [
          "평소보다 상대의 좋은 점이 잘 보이는 날이야. 당연하게 여겼던 배려가 있다면 오늘 한마디 전해봐.",
          "내 마음도 표현하고 나면 한결 부드러워질 수 있어. 고마운 말을 들었을 때는 쑥스러워하며 화제를 급히 바꾸지 않아도 돼. 편하게 받아들이는 것도 다정한 답이 될 거야."
        ]
      },
      "money": {
        "score": 82,
        "text": [
          "오늘은 비용과 이용 조건을 함께 개선할 기회를 찾기 좋아. 자주 쓰는 서비스의 요금제를 다시 살펴봐.",
          "같은 돈으로 더 필요한 기능을 쓰거나 불필요한 비용을 줄일 방법이 보일 수 있어. 변경 전에는 기존 혜택이 사라지는지도 확인해둬. 내 이용 방식에 맞는 조건을 찾았다면 바꿔볼 만한 날이야."
        ]
      },
      "work": {
        "score": 48,
        "text": [
          "계획한 양을 채우는 데는 무리가 없지만 서두르면 빠지는 것이 생길 수 있어. 앞부분을 빨리 끝냈다고 검토까지 생략하지는 마.",
          "쉬운 내용일수록 조건을 끝까지 읽어봐. 다른 일로 넘어가기 전에는 저장하거나 전달할 것이 남았는지 확인하는 게 좋아. 오늘은 마지막 몇 분을 잘 쓰면 깔끔하게 마무리할 수 있어."
        ]
      },
      "energy": {
        "score": 60,
        "text": [
          "새로 해보고 싶은 활동에 관심이 생기는 날이야. 준비물을 많이 사기 전에 짧게 체험할 방법부터 찾아봐.",
          "해보니 재미있다면 다음에 또 할 시간을 정해도 좋아. 다른 사람이 잘한다고 처음부터 따라 하지는 마. 오늘은 나에게 맞는 활동인지 알아보는 것만으로 충분해."
        ]
      }
    }
  },
