...
_ONBOARDING_EN = [
    "So you're {name}? I'm Cappy. I live here. Glad you came. Look around if it feels new. Talk to me whenever you like.",
    "Oh hey {name}. Nice to meet you. I'm Cappy and this is my place. No rush. Just settle in.",
]
_HOME_BY_TIME_EN = {
    "dawn": [
...
_ONBOARDING_JA = [
    "{name}？ぼくはキャピー、この家に住んでるんだ。よく来たね、{name}。慣れないならゆっくり見て回っていいよ。話したくなったら気軽に声をかけて。",
    "あ、{name}。会えてうれしいよ。ぼくはキャピーっていうんだ。ここはぼくの家。急がなくていいから、ゆっくりしてって。",
]
_HOME_BY_TIME_JA = {
    "dawn": [
        "こんな時間に起きてるんだね。眠れない？",
        "まだ寝てなかったんだ。ぼくも今起きたところ。",
...
_POOLS_JA = {
    ...
    "evening": [
        ...
        "今日もおつかれさま。変わったことなかった？",
        "今日もおつかれさま。今日はどうだった？",
        "一日終わったね。ぼくは窓を開けて過ごしてた。",
        "夕方だね。ぼくはさっきごはんを食べてきたよ。",
    ],
    "comeback": [
...
_NONKO_POOLS = {
    "en": (
        ...
        "I'm Cappy. I live here. Talk to me whenever you like.", "you",
    ),
    "ja": (
        _ONBOARDING_JA, _HOME_BY_TIME_JA, _POOLS_JA,
        "ぼくはキャピー。この家に住んでるんだ。話したくなったら気軽に声をかけて。", "あなた",
    ),
}
