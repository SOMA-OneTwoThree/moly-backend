"""사용자별 schedule 3종 — indexed due scheduler의 좌표(15장 4번).
...
⚠️ **아직 읽기 경로가 아니다.** 문서(15장 4번)는 schedule 3종 count가 각각 활성 profile 수와
...
def all_due(tz_name: str, now: datetime) -> list[Due]:
    """한 사용자의 3종 전부. profile 생성과 backfill이 같은 함수를 쓴다."""
