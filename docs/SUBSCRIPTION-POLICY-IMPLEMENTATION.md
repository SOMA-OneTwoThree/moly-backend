...
2026-09-23. 운영 변경·운영 PR 없음. 개발 배포와 실제 검증 결과는 별도 검증 보고서에 기록한다.
...
- 활성 구독은 스토어에서 확인된 기간까지 보장한다. 취소=즉시 박탈이 아니며 만료/환불과 구별한다. 기존 RevenueCat 이전/복원 로직, 원결제자·건초 기록을 보존한다.
